...
test.describe('Product Reviews', () => {
  test('should submit a product review @firefox', async () => {
  ...
  test('should edit and delete a product review @firefox', async () => {
...
test.describe('Product Filtering', () => {
  test('should filter products by price range @webkit', async () => {
    await login();
    await allPages.homePage.clickOnShopNowButton();
...
test.describe('Wishlist', () => {
  test('should wishlist product and complete checkout @webkit', async () => {
    await login();
...
test.describe('Order Journey', () => {
  test('should place and cancel an order @webkit', async () => {
...
test.describe('Registration', () => {
  test('should register new user and place order @chromium', async () => {
